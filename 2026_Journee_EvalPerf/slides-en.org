...
\institute{
\\\bigskip
\textbf{Journée thématique Analyse de performance GDR C4P \\
...
Computer Science
- Undergraduate UFSM (2003), Master (2005)
- Co-advised Phd between UFRGS and INPG, Grenoble, France (2009)
- CNRS Postdoc (2010 -- 2012)
- Inria Postdoc (2016/2017)

** Instituto de Informática em Porto Alegre (RS)

General overview of the *Porto Alegre* city
#+latex: \vspace{-.2cm}
...
Historic Downtown *Porto Alegre* city
#+latex: \vspace{-.2cm}
#+attr_latex: :width \linewidth
[[./img/guaiba.jpg]]
...
#+BEGIN_CENTER
Informatics Institute gardens
#+END_CENTER

** Programa de Pós-Graduação em Computação (PPGC)                 :noexport:
...
** Computational Assets (PCAD)

URL: http://pcad.inf.ufrgs.br/

Around \approx50 nodes, \approx1000+ CPU cores and \approx100000+ GPU cores

#+attr_latex: :width .75\linewidth
[[./img/20240819_104551.jpg]]

Informatics Institute's  /Data Center/, UFRGS

Work Group
- Education for HPC DevOps
- SLURM, NFS, LDAP, ...
