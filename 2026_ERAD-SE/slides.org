...
#+LaTeX_CLASS: beamer
#+LaTeX_CLASS_OPTIONS: [10pt, xcolor=dvipsnames,aspectratio=169]
...
\institute{
\\\bigskip
\textbf{Escola Regional de Alto Desempenho Região Sudeste \\
Universidade Federal de Juiz de Fora (UFJF) \\
Juiz de Fora - MG, 12 de agosto de 2026\\\vspace{1cm}
\includegraphics[scale=0.12]{./logo/inf-logo-1.0.pdf}\hfill%
\includegraphics[scale=0.17]{./logo/ufrgs.pdf}\hfill%
\includegraphics[scale=0.1]{./img/eradse.pdf}%
}}
#+end_export
...
- _Mestrado_, entradas semestrais
  ...
  - Bolsas por projeto, entrar em contato com professores
...
Temos um GT (Grupo de Trabalho) \to DevOps para HPC @ ERAD/RS 2023
...
Aplicação é um grafo de tarefas \to Paradigma /Sequential Task Flow/ -- STF
...
\begin{columns}\begin{column}{.40\linewidth}\small
...
Seis paineis de análise
1. Processamento da árvore de eliminação
2. Intensidade de processamento por nó da árvore
3. Intensidade de processamento por profundidade da árvore
4. Quantidade de nós ativos
5. Quantidade de memória utilizada
6. Comportamento dos trabalhadores [cores são os tipos de tarefas]
